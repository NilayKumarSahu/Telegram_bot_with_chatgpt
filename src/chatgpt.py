...
async def welcome(message: types.Message):
    ...
    """
    clear_past()
    await message.reply(f"Hello! \nI'm Talky a Telegram Bot powered by ChatGpt, Created by Nilay!\nHow may I assist you?")
...
async def clear(message: types.Message):
    ...
    """
    clear_past()
    await message.reply(f"Your past conversations have been cleared")
...
async def helper(message: types.Message):
    ...
    """
    help_command = """
    Hey, I am Talky a telegram bot powered by ChatGpt, Created by Nilay! Please follow these commands - 
